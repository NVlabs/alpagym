"""Behavior tests for the native VLA Psi actor-critic core."""
...
class _FakePsi(torch.nn.Module):
    ...
    def _select_vlm_planner_hidden(
        ...
        """Mirror VLA's current identity planner-token selection."""
...
def _inputs(model: VlaPsiActorCritic) -> dict[str, Any]:
